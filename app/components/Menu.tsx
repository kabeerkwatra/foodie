...
export default function Menu({restaurant,pincode,username}:any){
    ...
    const {data:menu} = useSWR(`/api/menu?restaurant=${restaurant}`,fetcher)
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            }} className="my-4 text-3xl p-4 bg-red-500 text-white rounded-3xl hover:ring-2 hover:ring-red-500" type="button">Submit order</button>
            </div>
    )
}
